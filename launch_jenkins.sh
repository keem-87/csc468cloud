...
sudo sed '/^    - --service-cluster-ip-range/a \ \ \ \ - --service-node-port-range=30000-50000' /etc/kubernetes/manifests/kube-apiserver.yaml > /etc/kubernetes/manifests/kube-apiserver.yaml
